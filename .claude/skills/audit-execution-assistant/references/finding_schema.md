...
| 来源 | 填写方式 | 示例 |
|------|---------|------|
| 从 evidence `_files/` 目录读取 | 从 catalog 的 `file` 字段获得路径，填入 `storage_path` | `evidence/人力资源管理_武汉长源/_files/SAP入库记录.xlsx` |
| 从程序专有目录读取 | 填入实际相对路径 | `evidence/人力资源管理_武汉长源/A-001_入库完整性穿行测试/现场盘点照片.jpg` |
